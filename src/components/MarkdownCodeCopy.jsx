...
export default function MarkdownCodeCopy() {
  ...
  function createCodeBlockButtons(codeBlock){
    ...
    const copySvg = htmlToElement("      <svg class='rounded w-8 h-8 p-2 ml-1 border border-neutral-700 border-solid bg-neutral-700 hover:bg-neutral-700 opacity-100 hover:opacity-100' viewBox=\"0 0 24 24\">\n" +
    ...
    if(needsWrap) {
      const wrapSvg = htmlToElement("      <svg class='rounded w-8 h-8 p-2 ml-1 border border-neutral-700 border-solid bg-neutral-700 hover:bg-neutral-700 opacity-100 hover:opacity-100' viewBox=\"0 0 24 24\" aria-hidden=\"true\">\n" +
