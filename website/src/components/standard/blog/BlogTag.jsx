...
export default function BlogTag({tag, showCount}) {
  ...
  return (
      <li className="m-1" key={tag.permalink}>
        <Link to={tag.permalink} className={`inline-flex text-center text-gray-100 py-1 px-3 rounded-full ${color} transition duration-150 ease-in-out`}>
          {tag.label}
