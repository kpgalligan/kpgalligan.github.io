        ...
        <section>
            <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-12 md:pb-16">
                ...
                <div className="max-w-3xl mx-auto text-center pb-12">
                    ...
                    <p className="text-xl text-gray-400">Vitae aliquet nec ullamcorper sit amet risus nullam eget felis
                ...
                <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
                    ...
                    <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
                      <div>
                        ...
                        <blockquote className="text-lg text-gray-400 grow">— Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                        </blockquote>
                        <div className="text-gray-700 font-medium mt-6  border-t border-gray-700">
                            <cite className="text-gray-200 not-italic">Anastasia Dan</cite> - <a
                            className="text-lime-600 hover:text-gray-200 transition duration-150 ease-in-out"
                            href="#0">JetBrains</a>
                        </div>
                    </div>
